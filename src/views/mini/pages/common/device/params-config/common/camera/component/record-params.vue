    ...
    <div style="height: calc(100% - 50px); overflow-y: auto">
      ...
      >
        <el-row :gutter="20">
          ...
          <el-col :span="6" v-if="platType !== PLATFORM_TYPE.IVS_1800">
      ...
      <p v-if="platType === PLATFORM_TYPE.IVS && cameraStatus === 1" class="form-title">
        {{ $t('mainDevConfiguration.puRecordConfig') }}
      </p>
      <el-form
        v-if="platType === PLATFORM_TYPE.IVS && cameraStatus === 1"
        ref="puStreamForm"
        :model="puStreamForm"
