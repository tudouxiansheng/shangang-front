        ...
        (req.load = function (e, t, i) {
          ...
          if (isWebWorker)
            try {
              ...
              e.onError(
                makeError('importscripts', 'importScripts failed for ' + t + ' at ' + i, r, [t])
              );
            }
        }),
        isBrowser &&
          ...
          : ((t[r] = !0),
            each(e.depMaps, function (r, n) {
              ...
              !a ||
                e.depMatched[n] ||
                i[o] ||
                (getOwn(t, o) ? (e.defineDep(n, p[o]), e.check()) : M(a, t, i));
            }),
            (i[r] = !0));
      }
      function O() {
        ...
        if (!t) {
          if (
            ...
            return (
              ((e = makeError('timeout', 'Load timeout for modules: ' + c, null, c)).contextName =
                r.contextName),
              y(e)
            );
          f &&
      ...
      return (
                  ...
                  if (((this.defining = !0), this.depCount < 1 && !this.defined)) {
                    ...
                    (this.exports = o),
                      this.map.isDefine &&
                        !this.ignore &&
                        ((p[i] = o),
                        req.onResourceLoad && req.onResourceLoad(r, this.map, this.depMaps)),
                      k(i),
                      (this.defined = !0);
                  }
                  (this.defining = !1),
        ...
        (r = {
          ...
          completeLoad: function (e) {
            ...
            if (
              ((r.defQueueMap = {}), (n = getOwn(s, e)), !t && !hasProp(p, e) && n && !n.inited)
            ) {
          ...
          onScriptError: function (e) {
            var t = R(e);
            if (!x(t.id))
              return y(makeError('scripterror', 'Script error for: ' + t.id, e, [t.id]));
          },
        }),
