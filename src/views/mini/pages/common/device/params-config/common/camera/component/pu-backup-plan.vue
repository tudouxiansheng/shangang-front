<template>
  <div id="backupPlan">
    ...
    >
      <el-row :gutter="20">
        <el-col :span="6">
          <el-form-item :label="$t('mainDevConfiguration.backupType')" prop="backupType">
        ...
        <el-col :span="6">
          <el-form-item :label="$t('mainDevConfiguration.streamType1')" prop="streamType">
...
export default {
  ...
  props: ['planInfo', 'isDisabled'],
  data() {
    return {
      streamTypeList: [
        {
          label: this.$t('mainDevConfiguration.streamType0'),
          value: 0
        },
        {
          label: this.$t('mainDevConfiguration.streamType11'),
          value: 1
        },
        {
          label: this.$t('mainDevConfiguration.streamType2'),
          value: 2
        },
        {
          label: this.$t('mainDevConfiguration.streamType3'),
          value: 3
        }
      ],
      pickerOptions: {
      ...
      formRules: {
        ...
        streamType: [
          {
            required: true,
            message: this.$t('mainDevConfiguration.streamTypeProp'),
            trigger: 'change'
          }
        ],
        scheduleType: [
        ...
        scheduleStartTime: [
          {
            required: true,
            message: this.$t('mainDevConfiguration.scheduleStartTimeProp1'),
            trigger: 'change'
          }
        ]
      },
