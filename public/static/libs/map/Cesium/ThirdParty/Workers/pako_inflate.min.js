  ...
  })(
    {
      ...
      8: [
        function (e, t, i) {
          ...
          function u(e) {
            var t;
            return e && e.state
              ? (((t = e.state).wsize = 0), (t.whave = 0), (t.wnext = 0), c(e))
              : f;
          }
          function h(e, t) {
            var i, n;
          ...
          function _(e) {
            if (k) {
              var t;
              for (m = new n.Buf32(512), w = new n.Buf32(32), t = 0; t < 144; ) e.lens[t++] = 8;
              for (; t < 256; ) e.lens[t++] = 9;
              for (; t < 280; ) e.lens[t++] = 7;
              for (; t < 288; ) e.lens[t++] = 8;
              for (s(1, e.lens, 0, 288, m, 0, e.work, { bits: 9 }), t = 0; t < 32; )
                e.lens[t++] = 5;
            ...
            return (
              ...
              a >= o.wsize
                ...
                : (a < (r = o.wsize - o.wnext) && (r = a),
                  ...
                  (a -= r)
                    ? (n.arraySet(o.window, t, i - a, a, 0), (o.wnext = a), (o.whave = o.wsize))
                    : ((o.wnext += r),
          ...
          (i.inflateReset = u),
            ...
            (i.inflate = function (e, t) {
              ...
              e: for (;;)
                switch (i.mode) {
                  case 1:
                    ...
                    if (((k -= 4), (N = 8 + (15 & (w >>>= 4))), 0 === i.wbits)) i.wbits = N;
                    else if (N > i.wbits) {
                    ...
                    if (
                      ...
                      x &&
                        (i.head &&
                          ...
                          n.arraySet(i.head.extra, d, u, x, N)),
                        512 & i.flags && (i.check = r(i.check, d, x, u)),
                        (b -= x),
                        (u += x),
                        (i.length -= x)),
                      i.length)
                  ...
                  case 7:
                    if (2048 & i.flags) {
                      ...
                      if ((512 & i.flags && (i.check = r(i.check, d, x, u)), (b -= x), (u += x), N))
                        break e;
                  ...
                  case 14:
                    ...
                    if (((i.length = 65535 & w), (k = w = 0), (i.mode = 15), 6 === t)) break e;
                  case 15:
                    i.mode = 16;
                  case 16:
                    if ((x = i.length)) {
                      if ((b < x && (x = b), m < x && (x = m), 0 === x)) break e;
                      n.arraySet(c, d, u, x, h),
                        (b -= x),
                        (u += x),
                        (m -= x),
                        (h += x),
                  ...
                  case 18:
                    ...
                    if (
                      ...
                      (i.lenbits = 7),
                      (C = { bits: i.lenbits }),
                      (O = s(0, i.lens, 0, 19, i.lencode, 0, i.work, C)),
                      (i.lenbits = C.bits),
                      O)
                    ) {
                  ...
                  case 19:
                    for (; i.have < i.nlen + i.ndist; ) {
                      for (
                        ;
                        (Z = ((D = i.lencode[w & ((1 << i.lenbits) - 1)]) >>> 16) & 255),
                          (B = 65535 & D),
                          !((E = D >>> 24) <= k);
                      ...
                      if (B < 16) (w >>>= E), (k -= E), (i.lens[i.have++] = B);
                      else {
                        if (16 === B) {
                          for (I = E + 2; k < I; ) {
                            if (0 === b) break e;
                          ...
                          (N = i.lens[i.have - 1]), (x = 3 + (3 & w)), (w >>>= 2), (k -= 2);
                        } else if (17 === B) {
                          for (I = E + 3; k < I; ) {
                            if (0 === b) break e;
                            b--, (w += d[u++] << k), (k += 8);
                          }
                          (k -= E), (N = 0), (x = 3 + (7 & (w >>>= E))), (w >>>= 3), (k -= 3);
                        } else {
                          for (I = E + 7; k < I; ) {
                            if (0 === b) break e;
                            b--, (w += d[u++] << k), (k += 8);
                          }
                          (k -= E), (N = 0), (x = 11 + (127 & (w >>>= E))), (w >>>= 7), (k -= 7);
                        }
                    ...
                    if (
                      ((i.lenbits = 9),
                      (C = { bits: i.lenbits }),
                      (O = s(1, i.lens, 0, i.nlen, i.lencode, 0, i.work, C)),
                      (i.lenbits = C.bits),
                      O)
                    ) {
                    ...
                    if (
                      ...
                      (C = { bits: i.distbits }),
                      (O = s(2, i.lens, i.nlen, i.ndist, i.distcode, 0, i.work, C)),
                      (i.distbits = C.bits),
                      O)
                    ) {
                  ...
                  case 21:
                    ...
                    if (Z && 0 == (240 & Z)) {
                      for (
                        A = E, z = Z, R = B;
                        (Z = ((D = i.lencode[R + ((w & ((1 << (A + z)) - 1)) >> A)]) >>> 16) & 255),
                          (B = 65535 & D),
                          !(A + (E = D >>> 24) <= k);
                    ...
                    if (((w >>>= E), (k -= E), (i.back += E), (i.length = B), 0 === Z)) {
                      i.mode = 26;
                      break;
                    }
                    if (32 & Z) {
                  ...
                  case 23:
                    for (
                      ;
                      (Z = ((D = i.distcode[w & ((1 << i.distbits) - 1)]) >>> 16) & 255),
                        (B = 65535 & D),
                        !((E = D >>> 24) <= k);
                    ...
                    if (0 == (240 & Z)) {
                      for (
                        A = E, z = Z, R = B;
                        (Z =
                          ((D = i.distcode[R + ((w & ((1 << (A + z)) - 1)) >> A)]) >>> 16) & 255),
                          (B = 65535 & D),
                          !(A + (E = D >>> 24) <= k);
                    ...
                    if (((w >>>= E), (k -= E), (i.back += E), 64 & Z)) {
                      (e.msg = 'invalid distance code'), (i.mode = 30);
                      break;
                    }
                    (i.offset = B), (i.extra = 15 & Z), (i.mode = 24);
                  case 24:
                    if (i.extra) {
                      for (I = i.extra; k < I; ) {
                        if (0 === b) break e;
                  ...
                  case 25:
                    ...
                    if (((x = p - m), i.offset > x)) {
                      ...
                      x > i.wnext ? ((x -= i.wnext), (y = i.wsize - x)) : (y = i.wnext - x),
                        x > i.length && (x = i.length),
                        (S = i.window);
                    } else (S = c), (y = h - i.offset), (x = i.length);
                    for (m < x && (x = m), m -= x, i.length -= x; (c[h++] = S[y++]), --x; );
                    0 === i.length && (i.mode = 21);
                    break;
                  case 26:
                    if (0 === m) break e;
                    (c[h++] = i.length), m--, (i.mode = 21);
                    break;
                  case 27:
                    if (i.wrap) {
                      for (; k < 32; ) {
                      ...
                      if (
                        ...
                        p &&
                          (e.adler = i.check =
                            i.flags ? r(i.check, c, p, h - p) : a(i.check, c, p, h - p)),
                        (p = m),
              ...
              return (
                ...
                (i.hold = w),
                (i.bits = k),
                (i.wsize || (p !== e.avail_out && i.mode < 30 && (i.mode < 27 || 4 !== t))) &&
                g(e, e.output, e.next_out, p - e.avail_out)
                  ...
                  : ((v -= e.avail_in),
                    ...
                    i.wrap &&
                      ...
                      (e.adler = i.check =
                        i.flags
                          ? r(i.check, c, p, e.next_out - p)
                          : a(i.check, c, p, e.next_out - p)),
                    (e.data_type =
                      i.bits +
                      (i.last ? 64 : 0) +
                      (12 === i.mode ? 128 : 0) +
      ...
      9: [
        function (e, t, i) {
          ...
          t.exports = function (e, t, i, f, l, d, c, u) {
            var h,
              b,
              m,
              w,
            ...
            for (B = x, Z = 15; 1 <= Z && 0 === D[Z]; Z--);
            if ((Z < B && (B = Z), 0 === Z))
              return (l[d++] = 20971520), (l[d++] = 20971520), (u.bits = 1), 0;
            for (E = 1; E < Z && 0 === D[E]; E++);
            for (B < E && (B = E), y = R = 1; y <= 15; y++)
              if (((R <<= 1), (R -= D[y]) < 0)) return -1;
            if (0 < R && (0 === e || 1 !== Z)) return -1;
            for (T[1] = 0, y = 1; y < 15; y++) T[y + 1] = T[y] + D[y];
            for (S = 0; S < f; S++) 0 !== t[i + S] && (c[T[t[i + S]]++] = S);
            if (
              (0 === e
                ? ((C = U = c), (_ = 19))
                : 1 === e
                ? ((C = a), (I -= 257), (U = r), (F -= 257), (_ = 256))
                : ((C = o), (U = s), (_ = -1)),
              (y = E),
              (k = d),
              (z = S = O = 0),
            ...
            for (;;) {
              for (
                g = y - z,
                  ...
                  h = 1 << (y - z),
                  E = b = 1 << A;
                (l[k + (O >> z) + (b -= h)] = (g << 24) | (v << 16) | p | 0), 0 !== b;

              );
              for (h = 1 << (y - 1); O & h; ) h >>= 1;
              if ((0 !== h ? ((O &= h - 1), (O += h)) : (O = 0), S++, 0 == --D[y])) {
                if (y === Z) break;
                y = t[i + c[S]];
              }
              if (B < y && (O & w) !== m) {
                for (
                  0 === z && (z = B), k += E, R = 1 << (A = y - z);
                  A + z < Z && !((R -= D[A + z]) <= 0);

                )
                  A++, (R <<= 1);
                if (((N += 1 << A), (1 === e && 852 < N) || (2 === e && 592 < N))) return 1;
                l[(m = O & w)] = (B << 24) | (A << 16) | (k - d) | 0;
              }
            }
            return 0 !== O && (l[k + O] = ((y - z) << 24) | (64 << 16) | 0), (u.bits = B), 0;
          };
        },
        { '../utils/common': 1 },
      ],
        ...
        function (e, t, i) {
          ...
          function c(e) {
            ...
            if (
              ...
              t.dictionary &&
                ...
                t.raw && (i = n.inflateSetDictionary(this.strm, t.dictionary)) !== o.Z_OK))
            )
              throw new Error(s[i]);
          }
          function u(e, t) {
          ...
          (c.prototype.push = function (e, t) {
            ...
            do {
              if (
                (0 === u.avail_out &&
                  ((u.output = new a.Buf8(h)), (u.next_out = 0), (u.avail_out = h)),
                (i = n.inflate(u, o.Z_NO_FLUSH)) === o.Z_NEED_DICT &&
                  b &&
                  (i = n.inflateSetDictionary(this.strm, b)),
                i === o.Z_BUF_ERROR && !0 === m && ((i = o.Z_OK), (m = !1)),
              ...
              u.next_out &&
                ((0 !== u.avail_out &&
                  i !== o.Z_STREAM_END &&
                  (0 !== u.avail_in || (s !== o.Z_FINISH && s !== o.Z_SYNC_FLUSH))) ||
                  ('string' === this.options.to
                    ? ((f = r.utf8border(u.output, u.next_out)),
                      (l = u.next_out - f),
                      (c = r.buf2string(u.output, f)),
                      (u.next_out = l),
                      (u.avail_out = h - l),
            ...
            } while ((0 < u.avail_in || 0 === u.avail_out) && i !== o.Z_STREAM_END);
            return (
              i === o.Z_STREAM_END && (s = o.Z_FINISH),
              s === o.Z_FINISH
                ? ((i = n.inflateEnd(this.strm)), this.onEnd(i), (this.ended = !0), i === o.Z_OK)
                : s !== o.Z_SYNC_FLUSH || (this.onEnd(o.Z_OK), !(u.avail_out = 0))
            );
          }),
