define([
  ...
  (f.rayTriangleParametric = function (a, r, n, s, o) {
    ...
    if (o) {
      ...
      if (((C = t.Cartesian3.cross(u, w, p)), (l = t.Cartesian3.dot(f, C)) < 0 || c + l > O))
        return;
      h = t.Cartesian3.dot(R, C) / O;
    } else {
      if (Math.abs(O) < i.CesiumMath.EPSILON6) return;
      var x = 1 / O;
      if (((u = t.Cartesian3.subtract(M, r, g)), (c = t.Cartesian3.dot(u, S) * x) < 0 || c > 1))
        return;
      if (((C = t.Cartesian3.cross(u, w, p)), (l = t.Cartesian3.dot(f, C) * x) < 0 || c + l > 1))
        return;
  ...
  function S(a, r, i) {
    ...
    var s = a.origin,
      ...
      l = (function (a, t, e, r) {
        ...
        t.Cartesian3.dot(o, o),
        2 * t.Cartesian3.dot(o, c),
