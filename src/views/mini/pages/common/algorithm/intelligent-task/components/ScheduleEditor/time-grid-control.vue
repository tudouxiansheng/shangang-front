...
export default {
  ...
  mounted() {
    this.time_initialize(this.type, 2, this.value || [])
  },
  destroyed() {
    this.closeControl()
  },
  ...
  watch: {
    value: function (val) {
      if (val !== recordPlanSubInfoList) {
        this.clearAll()
        this.time_initialize(this.type, 2, val || [])
      }
    },
    type: function (val) {
      this.clearAll()
      this.planTypeChange(this.type)
      this.$emit('input', [])
    },
  },
  methods: {
    onPossibleChange() {
      ...
      this.$emit('input', recordPlanSubInfoList)
    },
    time_ready() {
      if (operation != 0) {
...
// {"planName":"saadasad","planType":1,"timeSpanList":[{"dayType":0,"startTime":"03:00:00","stopTime":"05:00:00"},{"dayType":0,"startTime":"08:00:00","stopTime":"16:30:00"}],"clientNonce":"87411766ef5660b2a9ab0005491d591bb42df2b5e11eac06","cuType":"4"}
// {"planName":"1312","planType":0,"timeSpanList":[{"dayType":1,"startTime":"01:30:00","stopTime":"02:00:00"},{"dayType":2,"startTime":"03:30:00","stopTime":"09:30:00"},{"dayType":3,"startTime":"03:30:00","stopTime":"09:30:00"},{"dayType":4,"startTime":"03:30:00","stopTime":"10:00:00"},{"dayType":4,"startTime":"11:00:00","stopTime":"11:30:00"},{"dayType":5,"startTime":"03:30:00","stopTime":"09:00:00"},{"dayType":5,"startTime":"13:00:00","stopTime":"13:30:00"}],"clientNonce":"1bd7a529525ae545021e52bd3329fd3e91303a763d4c0bc0","cuType":"4"}
</script>
