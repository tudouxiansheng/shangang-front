  ...
  <div class="main-wrapper">
    <div class="wscn-http404-container">
      <div class="wscn-http404">
        ...
        <div class="bullshit">
          <div class="bullshit__oops">{{ $t('error.update') }}</div>
          <!--          <div class="bullshit__headline">{{ message }}</div>-->
          <div class="bullshit__info">{{ $t('error.click') }}</div>
          <div @click="handleBack" class="bullshit__return-home">{{ $t('error.back') }}</div>
        </div>
      </div>
    </div>
  </div>
