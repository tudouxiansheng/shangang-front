<template>
  ...
  >
    ...
    <div v-show="!showSubLayout">
      <el-row>
        <el-col :span="0" class="el-row4" v-show="false">
        ...
        <el-col :span="24" class="el-row20">
          ...
          <div v-if="selectedTreeNodeType === 'area'" class="search-form searchSelect">
            <el-form
              ...
              :label-width="locale == 'en' ? '170px' : '160px'"
              ref="form"
              :model="searchForm"
              label-position="left"
            >
          ...
          <div style="margin-top: 18px" v-loading="loading" :element-loading-text="$t('public.loading')">
...
import Excel from '@components/excel/importExcel.vue'
import { ExportExcelModal } from '@components/batch'
import deviceAdd from '../intelligent-task/component/device-add.vue'
import deviceBarchAdd from '../intelligent-task/component/device-batch-add.vue'
import deviceModify from '../intelligent-task/component/device-modify.vue'
import deviceDetail from '../intelligent-task/component/device-detail.vue'
import deviceVideoChannel from '../intelligent-task/component/device-video-channel.vue'
import deviceAllcate from '../intelligent-task/component/device-allcate.vue'
import deviceAllcateErrorList from '../../device/component/device-allcate-error-list.vue'
import importFailList from '@views/mini/pages/common/component/import-fail-list.vue'
import recordPolicyFailList from '../intelligent-task/component/recordPolicy-failList.vue'
import baseInfo from '@views/mini/pages/common/config/pu-config.vue'
import batchOperate from '@components/batchOperate.vue' //批量操作
import breadcrumb from '@components/breadcrumb.vue' //面包屑
import addFailList from '../intelligent-task/component/add-failList.vue'
import LazySearchTree from '@components/lazy-search-tree.vue'
