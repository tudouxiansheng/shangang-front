<template>
  ...
  >
    ...
    <batch-operate
      :multipleSelection="
        operate == $t('public.batchImport') || operate == $t('primaryDevice.importADS') ? batchList : multipleSelection
      "
    ...
    <el-dialog :title="$t('batchOperator.failList')" v-model="batchVisible" width="800px" class="failDialog" draggable>
      <el-table
        max-height="200"
        :data="failInfos"
