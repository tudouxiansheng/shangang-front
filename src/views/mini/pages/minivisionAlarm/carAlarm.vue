<template>
  <div class="box">
    ...
    <div class="tables">
      ...
      >
        <el-table-column prop="alarmDevName" label="告警源名称" show-overflow-tooltip>
          <template slot-scope="scope">
            {{ scope.row.alarmDevName }}
          </template>
        </el-table-column>
        <el-table-column prop="captureImage" label="告警抓拍图">
          <template slot-scope="scope">
        ...
        <!-- <el-table-column label="告警确认">
                      <template slot-scope="scope">
                          ...
                          <el-button v-else type="warning" @click="dealAlarm(scope.row)">详情</el-button>
                      </template>
                  </el-table-column> -->
      </CustomTable>
    </div>
  ...
  methods: {
    ...
    async getAlarmListNew() {
      AItablistSearch({
        ...
        alarmTypeList: ['VEHICLE_MONITOR_ALARM'],
      ...
      //                 typeList: ["VEHICLE_MONITOR_ALARM"],
      //             },
      //         };
    ...
    numberChange(data) {
      this.searchList.pageInfo.pageSize = data
      this.getAlarmListNew()
    },
    handleCurrentChange(val) {
      this.searchList.pageInfo.pageNum = val
      this.getAlarmListNew()
    },
    ...
    date_format() {
      this.searchInfo.startTime = this.time(this.dateValue[0]).split(' ')[0] + ' ' + '00:00:00'
