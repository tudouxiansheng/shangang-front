define([
  ...
  function D(t, a) {
    ...
    return (
      (N.indices = k),
      r.st &&
        (N.attributes.st = new o.GeometryAttribute({
          componentDatatype: i.ComponentDatatype.FLOAT,
  ...
  function N(r, n) {
    ...
    y.st &&
      ((k = E.attributes.st.values), q.set(k), q.set(k, (G / 3) * 2), (E.attributes.st.values = q));
    var K = E.indices,
      $ = K.length,
      tt = G / 3,
    ...
    y.st &&
      (wt.attributes.st = new o.GeometryAttribute({
        componentDatatype: i.ComponentDatatype.FLOAT,
        componentsPerAttribute: 2,
        values: dt,
      })),
