define([
...
], function (e, t, i, r, o, a, n, s, l, d, u, p, f, h, y, c, b, g, m, v, A, _) {
  'use strict';
  ...
  function T(e, t) {
    var i,
      ...
      c = e.corners,
      b = e.endPositions,
      g = new u.GeometryAttributes(),
      m = 0,
      v = 0,
      A = 0;
    for (o = 0; o < y.length; o += 2)
      (m += f = y[o].length - 3), (A += (f / 3) * 4), (v += y[o + 1].length - 3);
    for (m += 3, v += 3, o = 0; o < c.length; o++) {
      i = c[o];
      var _ = c[o].leftPositions;
      l.defined(_)
        ? ((m += f = _.length), (A += (f / 3) * 2))
        : ((v += f = c[o].rightPositions.length), (A += (f / 3) * 2));
    }
    var T,
      P = l.defined(b);
    P && ((m += T = b[0].length - 3), (v += T), (A += 4 * (T /= 3)));
    var w,
      L,
      D,
      x,
    ...
    var U = 0,
      ...
      Y = y[U++];
    for (
      V.set(F, H), V.set(Y, I - Y.length + 1), f = Y.length - 3, h.push(H / 3, (I - 2) / 3), o = 0;
      o < f;
      o += 3
    )
      (x = (L = H / 3) + 1),
      ...
      if (l.defined(J)) {
        for (I -= 3, W = D, h.push(x), q = 0; q < J.length / 3; q++)
          (z = r.Cartesian3.fromArray(J, 3 * q, z)),
            ...
            (I -= 3);
        h.push(W - Math.floor(J.length / 6)),
          t === n.CornerType.BEVELED && h.push((I - 2) / 3 + 1),
          (H += 3);
      } else {
        for (H += 3, W = x, h.push(D), q = 0; q < j.length / 3; q++)
          (z = r.Cartesian3.fromArray(j, 3 * q, z)),
            (B[M++] = W + q),
            (B[M++] = W + q + 1),
            s.CorridorGeometryLibrary.addAttribute(V, z, H),
            (H += 3);
        h.push(W + Math.floor(j.length / 6)),
          t === n.CornerType.BEVELED && h.push(H / 3 - 1),
          (I -= 3);
      }
      for (
        F = y[U++],
          Y = y[U++],
          F.splice(0, 3),
          Y.splice(Y.length - 3, 3),
          V.set(F, H),
          V.set(Y, I - Y.length + 1),
          f = Y.length - 3,
          q = 0;
        q < Y.length;
        q += 3
    ...
    return (
      (B[M++] = H / 3),
      (B[M++] = (I - 2) / 3),
      (g.position = new d.GeometryAttribute({
        componentDatatype: a.ComponentDatatype.DOUBLE,
        componentsPerAttribute: 3,
        values: V,
      })),
      { attributes: g, indices: B, wallIndices: h }
    );
  }
  function P(e) {
  ...
  return (
    (P.unpack = function (e, t, i) {
      ...
      for (var o = e[t++], a = new Array(o), n = 0; n < o; ++n, t += r.Cartesian3.packedLength)
        a[n] = r.Cartesian3.unpack(e, t);
    ...
    (P.createGeometry = function (o) {
      ...
      if (!(y.length < 2 || u <= 0)) {
        var c,
          b = o._height,
          g = o._extrudedHeight,
          m = !a.CesiumMath.equalsEpsilon(b, g, 0, a.CesiumMath.EPSILON2),
          v = {
            ellipsoid: h,
            positions: y,
            width: u,
          ...
          (v.height = b),
            ...
            (c = (function (t) {
              var i = t.ellipsoid,
                ...
                c = h.position.values,
                b = c.length,
                g = new Float64Array(b);
              g.set(c);
              var m,
                v = new Float64Array(2 * b);
              if (
                ((c = f.PolygonPipeline.scaleToGeodeticHeight(c, n, i)),
                (g = f.PolygonPipeline.scaleToGeodeticHeight(g, u, i)),
                v.set(c),
                v.set(g, b),
                (h.position.values = v),
                (b /= 3),
              ...
              for (m = 0; m < o.length; m++) (P = (G = o[m]) + b), (C[w++] = G), (C[w++] = P);
              return { attributes: h, indices: C };
            })(v));
        else if (
          (((c = T(
            s.CorridorGeometryLibrary.computePositions(v),
            v.cornerType
